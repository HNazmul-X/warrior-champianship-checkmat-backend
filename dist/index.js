...
const colorLogging_1 = require("./utilities/colorLogging");
...
mongoose_1.default.connect(mongoURI, { dbName: "Warrior-Competition-V2" }).then(() => (0, colorLogging_1.logSuccess)("Database Connected"));
